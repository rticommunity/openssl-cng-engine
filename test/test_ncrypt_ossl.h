...
using unique_X509_STORE = unique_ptr< X509_STORE, X509_STORE_free>;
using unique_X509_STORE_CTX = unique_ptr< X509_STORE_CTX, X509_STORE_CTX_free>;
...
#define OSSL_ASSERT_TRUE(val) ASSERT_TRUE(val) << ncrypt_testing::GetOpenSSLErrors()
#define OSSL_ASSERT_EQ(val1, val2) ASSERT_EQ(val1, val2) << ncrypt_testing::GetOpenSSLErrors()
#define OSSL_ASSERT_NE(val1, val2) ASSERT_NE(val1, val2) << ncrypt_testing::GetOpenSSLErrors()
#define OSSL_ASSERT_LT(val1, val2) ASSERT_LT(val1, val2) << ncrypt_testing::GetOpenSSLErrors()
#define OSSL_ASSERT_LE(val1, val2) ASSERT_LE(val1, val2) << ncrypt_testing::GetOpenSSLErrors()
#define OSSL_ASSERT_GT(val1, val2) ASSERT_GT(val1, val2) << ncrypt_testing::GetOpenSSLErrors()
#define OSSL_ASSERT_GE(val1, val2) ASSERT_GE(val1, val2) << ncrypt_testing::GetOpenSSLErrors()

#define OSSL_EXPECT_TRUE(val) EXPECT_TRUE(val) << ncrypt_testing::GetOpenSSLErrors()
#define OSSL_EXPECT_EQ(val1, val2) EXPECT_EQ(val1, val2) << ncrypt_testing::GetOpenSSLErrors()
#define OSSL_EXPECT_NE(val1, val2) EXPECT_NE(val1, val2) << ncrypt_testing::GetOpenSSLErrors()
#define OSSL_EXPECT_LT(val1, val2) EXPECT_LT(val1, val2) << ncrypt_testing::GetOpenSSLErrors()
#define OSSL_EXPECT_LE(val1, val2) EXPECT_LE(val1, val2) << ncrypt_testing::GetOpenSSLErrors()
#define OSSL_EXPECT_GT(val1, val2) EXPECT_GT(val1, val2) << ncrypt_testing::GetOpenSSLErrors()
#define OSSL_EXPECT_GE(val1, val2) EXPECT_GE(val1, val2) << ncrypt_testing::GetOpenSSLErrors()
